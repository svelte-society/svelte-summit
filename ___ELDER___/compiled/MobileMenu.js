...
const MobileMenu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    ...
    <li class="${"svelte-r3oh4p"}"><a href="${"https://forms.gle/6PBKXng9jfrvxjhX8"}" rel="${"noreferrer"}" target="${"_blank"}" class="${"svelte-r3oh4p"}">Sign up
      </a></li>
    <li class="${"svelte-r3oh4p"}"><a target="${"_blank"}" href="${"https://twitter.com/sveltesociety"}" class="${"svelte-r3oh4p"}">Twitter</a></li></ul>
  <button class="${"svelte-r3oh4p"}"><img src="${"/images/close.svg"}" alt="${""}" class="${"svelte-r3oh4p"}"></button></div>`;
});
