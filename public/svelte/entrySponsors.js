            ...
            function create_fragment(ctx) {
            	...
            	const block = {
            		...
            		h: function hydrate() {
            			...
            			if (img3.src !== (img3_src_value = "/images/sponsors/humancontentlogo.png")) attr_dev(img3, "src", img3_src_value);
            			attr_dev(img3, "alt", "");
            			...
            			add_location(span1, file, 169, 27, 4231);
            			attr_dev(div2, "class", "sponsor svelte-5sn1n8");
            			add_location(div2, file, 169, 6, 4210);
            			attr_dev(span2, "class", "svelte-5sn1n8");
            			add_location(span2, file, 170, 27, 4295);
            			attr_dev(div3, "class", "sponsor svelte-5sn1n8");
            			add_location(div3, file, 170, 6, 4274);
            			attr_dev(span3, "class", "svelte-5sn1n8");
            			add_location(span3, file, 171, 27, 4359);
            			attr_dev(div4, "class", "sponsor svelte-5sn1n8");
            			add_location(div4, file, 171, 6, 4338);
            			...
            			add_location(a4, file, 175, 77, 4586);
            			attr_dev(p, "class", "info svelte-5sn1n8");
            			add_location(p, file, 173, 4, 4411);
