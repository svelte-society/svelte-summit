        ...
        execute: function () {
            ...
            function create_fragment(ctx) {
            	...
            	const block = {
            		...
            		h: function hydrate() {
            			attr_dev(h2, "class", "svelte-1u82gkx");
            			add_location(h2, file, 130, 4, 2658);
            			if (img0.src !== (img0_src_value = "/images/sponsors/aws.svg")) attr_dev(img0, "src", img0_src_value);
            			attr_dev(img0, "alt", "");
            			attr_dev(img0, "class", "svelte-1u82gkx");
            			add_location(img0, file, 138, 8, 2964);
            			attr_dev(a0, "href", "https://aws.amazon.com/amplify/");
            			attr_dev(a0, "rel", "noopener noreferrer");
            			attr_dev(a0, "target", "_blank");
            			attr_dev(a0, "class", "sponsor svelte-1u82gkx");
            			attr_dev(a0, "data-tooltip", "AWS Amplify – The fastest, easiest way to develop mobile and web apps that scale");
            			add_location(a0, file, 132, 6, 2719);
            			if (img1.src !== (img1_src_value = "/images/sponsors/b3coderight.svg")) attr_dev(img1, "src", img1_src_value);
            			attr_dev(img1, "alt", "");
            			attr_dev(img1, "class", "svelte-1u82gkx");
            			add_location(img1, file, 145, 8, 3161);
            			attr_dev(a1, "href", "https://www.coderight.se");
            			attr_dev(a1, "rel", "noopener noreferrer");
            			attr_dev(a1, "target", "_blank");
            			attr_dev(a1, "class", "sponsor svelte-1u82gkx");
            			add_location(a1, file, 140, 6, 3027);
            			attr_dev(span0, "class", "svelte-1u82gkx");
            			add_location(span0, file, 147, 27, 3253);
            			attr_dev(div0, "class", "sponsor svelte-1u82gkx");
            			add_location(div0, file, 147, 6, 3232);
            			attr_dev(div1, "class", "gold sponsors svelte-1u82gkx");
            			add_location(div1, file, 131, 4, 2685);
            			if (img2.src !== (img2_src_value = "/images/sponsors/oasis.svg")) attr_dev(img2, "src", img2_src_value);
            			attr_dev(img2, "alt", "");
            			attr_dev(img2, "class", "svelte-1u82gkx");
            			add_location(img2, file, 156, 8, 3634);
            			attr_dev(a2, "href", "https://oasisdigital.com");
            			attr_dev(a2, "rel", "noopener noreferrer");
            			attr_dev(a2, "target", "_blank");
            			attr_dev(a2, "class", "sponsor svelte-1u82gkx");
            			...
            			add_location(a2, file, 150, 6, 3341);
            			attr_dev(span1, "class", "svelte-1u82gkx");
            			add_location(span1, file, 158, 27, 3720);
            			attr_dev(div2, "class", "sponsor svelte-1u82gkx");
            			add_location(div2, file, 158, 6, 3699);
            			attr_dev(span2, "class", "svelte-1u82gkx");
            			add_location(span2, file, 159, 27, 3784);
            			attr_dev(div3, "class", "sponsor svelte-1u82gkx");
            			add_location(div3, file, 159, 6, 3763);
            			attr_dev(span3, "class", "svelte-1u82gkx");
            			add_location(span3, file, 160, 27, 3848);
            			attr_dev(div4, "class", "sponsor svelte-1u82gkx");
            			add_location(div4, file, 160, 6, 3827);
            			attr_dev(div5, "class", "silver sponsors svelte-1u82gkx");
            			add_location(div5, file, 149, 4, 3305);
            			attr_dev(a3, "href", "mailto:sponsors@sveltesociety.dev");
            			add_location(a3, file, 164, 77, 4075);
            			attr_dev(p, "class", "info svelte-1u82gkx");
            			add_location(p, file, 162, 4, 3900);
            			attr_dev(div6, "class", "container svelte-1u82gkx");
            			add_location(div6, file, 129, 2, 2630);
            			attr_dev(div7, "class", "background svelte-1u82gkx");
            			attr_dev(div7, "id", "sponsors");
            			add_location(div7, file, 128, 0, 2589);
            		},
