        ...
        execute: function () {
            ...
            function create_fragment(ctx) {
            	...
            	const block = {
            		...
            		h: function hydrate() {
            			attr_dev(h2, "class", "svelte-1avacb8");
            			add_location(h2, file, 125, 4, 2675);
            			if (img0.src !== (img0_src_value = "/images/sponsors/aws.svg")) attr_dev(img0, "src", img0_src_value);
            			attr_dev(img0, "alt", "");
            			attr_dev(img0, "class", "svelte-1avacb8");
            			add_location(img0, file, 133, 8, 2980);
            			attr_dev(a0, "href", "https://aws.amazon.com/amplify/");
            			attr_dev(a0, "rel", "noopener noreferrer");
            			attr_dev(a0, "target", "_blank");
            			attr_dev(a0, "class", "sponsor svelte-1avacb8");
            			attr_dev(a0, "data-tooltip", "AWS Amplify – The fastest, easiest way to develop mobile and web apps that scale");
            			add_location(a0, file, 127, 6, 2735);
            			if (img1.src !== (img1_src_value = "/images/sponsors/b3coderight.svg")) attr_dev(img1, "src", img1_src_value);
            			attr_dev(img1, "alt", "");
            			attr_dev(img1, "class", "svelte-1avacb8");
            			add_location(img1, file, 140, 8, 3177);
            			attr_dev(a1, "href", "https://www.coderight.se");
            			attr_dev(a1, "rel", "noopener noreferrer");
            			attr_dev(a1, "target", "_blank");
            			attr_dev(a1, "class", "sponsor svelte-1avacb8");
            			add_location(a1, file, 135, 6, 3043);
            			attr_dev(div0, "class", "gold sponsors svelte-1avacb8");
            			add_location(div0, file, 126, 4, 2701);
            			if (img2.src !== (img2_src_value = "/images/sponsors/oasis.svg")) attr_dev(img2, "src", img2_src_value);
            			attr_dev(img2, "alt", "");
            			attr_dev(img2, "class", "svelte-1avacb8");
            			add_location(img2, file, 150, 8, 3586);
            			attr_dev(a2, "href", "https://oasisdigital.com");
            			attr_dev(a2, "rel", "noopener noreferrer");
            			attr_dev(a2, "target", "_blank");
            			attr_dev(a2, "class", "sponsor svelte-1avacb8");
            			...
            			add_location(a3, file, 152, 6, 3651);
            			attr_dev(div1, "class", "silver sponsors svelte-1avacb8");
            			add_location(div1, file, 143, 4, 3257);
            			attr_dev(a4, "href", "mailto:sponsors@sveltesociety.dev");
            			add_location(a4, file, 163, 54, 4246);
            			attr_dev(p, "class", "info svelte-1avacb8");
            			add_location(p, file, 161, 4, 4096);
            			attr_dev(div2, "class", "container svelte-1avacb8");
            			add_location(div2, file, 124, 2, 2647);
            			attr_dev(div3, "class", "background svelte-1avacb8");
            			attr_dev(div3, "id", "sponsors");
            			add_location(div3, file, 123, 0, 2606);
            		},
