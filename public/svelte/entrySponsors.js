        ...
        execute: function () {
            ...
            function create_fragment(ctx) {
            	...
            	const block = {
            		...
            		h: function hydrate() {
            			attr_dev(h2, "class", "svelte-1t0iojh");
            			add_location(h2, file, 127, 4, 2677);
            			if (img0.src !== (img0_src_value = "/images/sponsors/aws.svg")) attr_dev(img0, "src", img0_src_value);
            			attr_dev(img0, "alt", "");
            			attr_dev(img0, "class", "svelte-1t0iojh");
            			add_location(img0, file, 135, 8, 2982);
            			attr_dev(a0, "href", "https://aws.amazon.com/amplify/");
            			attr_dev(a0, "rel", "noopener noreferrer");
            			attr_dev(a0, "target", "_blank");
            			attr_dev(a0, "class", "sponsor svelte-1t0iojh");
            			attr_dev(a0, "data-tooltip", "AWS Amplify – The fastest, easiest way to develop mobile and web apps that scale");
            			add_location(a0, file, 129, 6, 2737);
            			if (img1.src !== (img1_src_value = "/images/sponsors/b3coderight.svg")) attr_dev(img1, "src", img1_src_value);
            			attr_dev(img1, "alt", "");
            			attr_dev(img1, "class", "svelte-1t0iojh");
            			add_location(img1, file, 142, 8, 3179);
            			attr_dev(a1, "href", "https://www.coderight.se");
            			attr_dev(a1, "rel", "noopener noreferrer");
            			attr_dev(a1, "target", "_blank");
            			attr_dev(a1, "class", "sponsor svelte-1t0iojh");
            			add_location(a1, file, 137, 6, 3045);
            			attr_dev(div0, "class", "gold sponsors svelte-1t0iojh");
            			add_location(div0, file, 128, 4, 2703);
            			if (img2.src !== (img2_src_value = "/images/sponsors/oasis.svg")) attr_dev(img2, "src", img2_src_value);
            			attr_dev(img2, "alt", "");
            			attr_dev(img2, "class", "svelte-1t0iojh");
            			add_location(img2, file, 152, 8, 3588);
            			attr_dev(a2, "href", "https://oasisdigital.com");
            			attr_dev(a2, "rel", "noopener noreferrer");
            			attr_dev(a2, "target", "_blank");
            			attr_dev(a2, "class", "sponsor svelte-1t0iojh");
            			...
            			add_location(a3, file, 154, 6, 3653);
            			attr_dev(div1, "class", "silver sponsors svelte-1t0iojh");
            			add_location(div1, file, 145, 4, 3259);
            			attr_dev(a4, "href", "mailto:sponsors@sveltesociety.dev");
            			add_location(a4, file, 165, 54, 4248);
            			attr_dev(p, "class", "info svelte-1t0iojh");
            			add_location(p, file, 163, 4, 4098);
            			attr_dev(div2, "class", "container svelte-1t0iojh");
            			add_location(div2, file, 126, 2, 2649);
            			attr_dev(div3, "class", "background svelte-1t0iojh");
            			attr_dev(div3, "id", "sponsors");
            			add_location(div3, file, 125, 0, 2608);
            		},
