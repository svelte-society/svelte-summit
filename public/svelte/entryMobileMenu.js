            ...
            function create_fragment(ctx) {
            	...
            	const block = {
            		...
            		h: function hydrate() {
            			...
            			add_location(a1, file, 53, 8, 868);
            			attr_dev(li1, "class", "svelte-r3oh4p");
            			add_location(li1, file, 53, 4, 864);
            			...
            			add_location(img, file, 55, 20, 973);
            			attr_dev(button, "class", "svelte-r3oh4p");
            			add_location(button, file, 55, 2, 955);
