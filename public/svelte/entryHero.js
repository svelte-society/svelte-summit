        ...
        execute: function () {
            ...
            function create_fragment$5(ctx) {
            	...
            	const block = {
            		...
            		h: function hydrate() {
            			if (img.src !== (img_src_value = "/dist/static/images/morning-sun.svg")) attr_dev(img, "src", img_src_value);
            ...
            function create_each_block_1(ctx) {
            	...
            	const block = {
            		...
            		h: function hydrate() {
            			...
            			add_location(a, file$7, 118, 33, 1870);
            		},
            		m: function mount(target, anchor) {
            ...
            function create_if_block(ctx) {
            	...
            	const block = {
            		...
            		h: function hydrate() {
            			...
            			attr_dev(img, "alt", "");
            			add_location(img, file$7, 145, 6, 2972);
            			attr_dev(button, "class", "svelte-fpzbx8");
            			add_location(button, file$7, 144, 4, 2921);
            			attr_dev(div, "class", "container svelte-fpzbx8");
            			add_location(div, file$7, 132, 2, 2445);
            		},
            		m: function mount(target, anchor) {
            			insert_dev(target, div, anchor);
            			append_dev(div, ul);
            ...
            function create_each_block(ctx) {
            	...
            	const block = {
            		...
            		h: function hydrate() {
            			...
            			attr_dev(a, "href", a_href_value = "/" + /*url*/ ctx[9]);
            			add_location(a, file$7, 135, 12, 2526);
            			attr_dev(li, "class", "svelte-fpzbx8");
            			add_location(li, file$7, 135, 8, 2522);
            		},
            		m: function mount(target, anchor) {
            ...
            function create_fragment$7(ctx) {
            	...
            	const block = {
            		...
            		h: function hydrate() {
            			...
            			add_location(a0, file$7, 120, 4, 1940);
            			...
            			attr_dev(img1, "alt", "");
            			add_location(img1, file$7, 129, 58, 2369);
            			attr_dev(div1, "class", "hamburger svelte-fpzbx8");
            			add_location(div1, file$7, 129, 0, 2311);
            		},
            		m: function mount(target, anchor) {
            ...
            function create_fragment$a(ctx) {
            	...
            	const block = {
            		...
            		h: function hydrate() {
            			if (img.src !== (img_src_value = "/dist/static/images/svelte-society-logo.svg")) attr_dev(img, "src", img_src_value);
